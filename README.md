...
- 在 Windows 任务栏左侧显示本周“工作”分类累计时长；标签会按实际 DPI、分辨率和任务栏尺寸自动定位，点击即可打开主程序；
...
- 任务栏状态标签每 15 秒刷新本周工作时长；全屏应用或自动隐藏的任务栏收起时，标签会自动隐藏。
- 点击热力图日期可查看当天时间轴；悬停活动段可查看详情，下方软件使用情况按当天累计时长排序。
